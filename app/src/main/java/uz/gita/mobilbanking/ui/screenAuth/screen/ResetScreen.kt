...
import uz.gita.mobilbanking.ui.screenAuth.viewModelAuth.ResetViewModel
...
class ResetScreen : Fragment(R.layout.screen_auth_reset), View.OnKeyListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.successResetLiveData.observe(this, successResetObserver)
        viewModel.successNewPasswordLiveData.observe(this, successNewPasswordObserver)
    ...
    private val successResetObserver = Observer<Unit> {
        isSuccessReset = true
    ...
    private val successNewPasswordObserver = Observer<Unit> {
