...
import uz.gita.mobilbanking.ui.screenAuth.viewModelAuth.RegisterViewModel
...
class RegisterScreen : Fragment(R.layout.screen_auth_register), View.OnKeyListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.successRegisterLiveData.observe(this, successRegisterObserver)
    ...
    private val successRegisterObserver = Observer<Unit> {
